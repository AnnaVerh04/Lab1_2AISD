...
void test_completion_average(int count_value, int count_attempt) {
    Set<int> set;
...
void test_erase_average(int count_value, int count_attempt) {
    Set<int> set;
    std::vector<int> vect;
    ...
    std::cout << "Time Running Erase to Set " << count_value << " items : " << duration.count() / count_attempt << std::endl;

    start = std::chrono::high_resolution_clock::now();
    for (int attempt = 0; attempt < count_attempt; attempt++) {
        int value = rand() % 10000000;
        std::vector<int>::iterator it = std::find(vect.begin(), vect.end(), value);
        if (it != vect.end())
            vect.erase(it);
    }
    stop = std::chrono::high_resolution_clock::now();
    ...
    std::cout << "Time Running Erase to Vector " << count_value << " items : " << duration.count() / count_attempt << std::endl;
}
...
int main()
{
    ...
    test_completion_average(1000, 100);
    test_completion_average(10000, 100);
    test_completion_average(100000, 100);

    /*test_search_average(1000, 1000);
    test_search_average(10000, 1000);
    test_search_average(100000, 1000);*/

    /*test_erase_average(1000, 1000);
    test_erase_average(10000, 1000);
    test_erase_average(100000, 1000);*/

    /*test_insert_average(1000, 1000);
    test_insert_average(10000, 1000);
    test_insert_average(100000, 1000);*/
